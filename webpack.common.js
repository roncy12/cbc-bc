...
module.exports = {
    ...
    resolve: {
        alias: {
            ...
            'stickySidebar': path.resolve(__dirname, 'node_modules/sticky-sidebar/dist/sticky-sidebar.js'),
            'resizeSensor': path.resolve(__dirname, 'node_modules/resize-sensor/ResizeSensor.js')
        },
    },
};
